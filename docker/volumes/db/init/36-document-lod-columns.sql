-- Mirrored from supabase/migrations/20260903160000_document_lod_columns.sql.
-- Fresh builds get the comments here; existing databases get them from the
-- migration. Keep the two identical.
-- =============================================================================
