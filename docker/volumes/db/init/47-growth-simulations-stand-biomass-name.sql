-- Mirrored from supabase/migrations/20260922130000_growth_simulations_stand_biomass_name.sql.
-- Fresh builds get the corrected view here; existing databases get it from the
-- migration. 10-baseline-schema.sql still creates the aliased version, so on a
-- fresh init this replaces what the baseline just built.
