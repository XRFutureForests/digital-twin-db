-- Mirrored from supabase/migrations/20260903130000_soil_aggregates_from_sensors.sql.
-- Fresh builds get the process row and the function here; existing databases get
-- them from the migration. Keep the two identical.
-- =============================================================================
