...
-- =============================================================================
-- Generated 2026-07-17 via schema-only pg_dump of the live dftdb-db instance.
-- Replaces former init files 10-29 and 32-37, which had accreted into a
-- replay-history problem (later files restructured objects created by earlier
-- ones on every fresh init). This file reproduces their combined end state in
-- one pass -- verified via structural diff (table/view/function/policy counts
-- and lookup row counts) against the live database before being adopted.
--
-- Future schema changes: add a new timestamped file under supabase/migrations/
-- (Supabase CLI), not a new numbered file here. See AGENTS.md "Schema Migrations".
-- =============================================================================
--
